...
void Z8536_Reset(void)
{

}

int Z8536_GetRegisterData(int nIndex)
{
	return z8536.Registers[nIndex];
}

int Z8536_GetInputs(int nIndex)
{
	return z8536.inputs[nIndex];
}


int Z8536_GetOutputs(int nIndex)
{
	return z8536.final_output[nIndex];
}
...
void Z8536_WriteData(unsigned char Address, unsigned char Data)
{
	switch (Address)
	{
		case 0:
		{
			...
			z8536.final_output[2] =
				(z8536.Registers[Z8536_REGISTER_PORT_B_DATA] ^
				 z8536.Registers[Z8536_REGISTER_PORT_B_DATA_PATH_POLARITY]);

			z8536_SetPortOutputs(2, z8536.final_output[2]);
		...
		case 1:
		{
			...
			z8536.final_output[1] =
				(z8536.Registers[Z8536_REGISTER_PORT_B_DATA] ^
				 z8536.Registers[Z8536_REGISTER_PORT_B_DATA_PATH_POLARITY]);

			z8536_SetPortOutputs(1, z8536.final_output[1]);
		}
		break;
		...
		case 2:
		{
			...
			z8536_SetPortOutputs(0, z8536.final_output[0]);
		}
		break;
