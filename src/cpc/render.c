...
static PIXEL_DATA          Mode4PixelData[256];
static PIXEL_DATA          Mode5PixelData[256];
/*
//static PIXEL_DATA          Mode6PixelData[256];
//static PIXEL_DATA          Mode7PixelData[256];
*/
...
PIXEL_DATA *CPC_GetModePixelData(int ModeIndex)
{
	switch (ModeIndex)
	{
		...
		case 6:
		{
			return &Mode4PixelData[0];
		}
		break;

		case 7:
		{
			return &Mode5PixelData[0];
		}
		break;
...
void    CPC_BuildModeRenderTables(void)
{
	...
	for (i=0; i<256; i++)
	{
		...
		Mode5PixelData[i].Pixel[0] = Pixel1;
		Mode5PixelData[i].Pixel[1] = Pixel1;
		Mode5PixelData[i].Pixel[2] = Pixel2;
		Mode5PixelData[i].Pixel[3] = Pixel2;
/*
//		Mode4PackedPixels[i] = PACK8_PIXELS(Pixel1,Pixel1,Pixel1,Pixel1,Pixel2,Pixel2,Pixel2,Pixel2);
...
//		Mode0PenIndex[i] = Pixel1;
	...
	for (i=0; i<256; i++)
	{
		...
		Mode4PixelData[i].Pixel[0] = Pixel1;
		Mode4PixelData[i].Pixel[1] = Pixel2;
		Mode4PixelData[i].Pixel[2] = Pixel3;
		Mode4PixelData[i].Pixel[3] = Pixel4;
